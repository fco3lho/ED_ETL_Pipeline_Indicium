...
for table in tables:
  csv_file = os.path.join(os.path.abspath(os.path.join(script_dir, os.pardir)), f"data/postgres/{table}/{current_date}.csv")
...
# CSV to Postgres
csv_file = os.path.join(os.path.abspath(os.path.join(script_dir, os.pardir)), f"data/csv/order_details/{current_date}.csv")
